...
public final class ThreadPoolUtils {
    ...
    public static ExecutorService createCpuThreadPool(String poolName) {
        return createThreadPool(CPU_INTENSIVE_NUM, poolName);
    }

    public static ExecutorService createIoThreadPool(String poolName) {
    ...
    public static ThreadFactory createThreadFactory(String poolName, boolean isDaemon) {
        ...
        threadFactoryBuilder.setDaemon(isDaemon);
